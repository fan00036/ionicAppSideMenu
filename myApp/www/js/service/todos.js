...
.factory('SettingFactory', function SettingFactory(localStorageService) {
    return { 
        setVibrate:function(isVibrate){
            localStorageService.set("vibrate", isVibrate);
        },
        
        setNotify:function(isNotify){
            localStorageService.set("notify", isNotify);
        },
        
        isVibrate:function(){
            return (localStorageService.get("vibrate")==null)?true:localStorageService.get("vibrate"); 
        },
        isNotify:function(){
            return (localStorageService.get("notify")==null)?true:localStorageService.get("notify"); 
        }
    }
